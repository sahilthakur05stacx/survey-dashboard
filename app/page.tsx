...
function AppSidebar({ setCurrentView, activeItem, setActiveItem }) {
  return (
...
function SurveyDashboard() {
  ...
  const handleViewWebsite = (website, tab = "build") => {
    setSelectedWebsite({ ...website, tab })
    setCurrentView("create-website")
  }

  // Library page view
  if (currentView === "library") {
    return <LibraryPage onBack={() => setCurrentView("dashboard")} onSelectTemplate={handleSelectTemplate} />
  }
  ...
  if (currentView === "create-website") {
    return (
      <SurveyEditor
        ...
        defaultTab={selectedWebsite ? selectedWebsite.tab || "build" : "build"}
      />
    )
  }
  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-gray-50">
        <AppSidebar setCurrentView={setCurrentView} activeItem={activeItem} setActiveItem={setActiveItem} />
              ...
              <div className="mx-auto max-w-7xl">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg text-gray-600">
                        Welcome back, <span className="font-semibold text-[#F5C842]">{user?.name?.split(" ")[0]}</span>!
                        You have <span className="font-semibold text-[#F5C842]">{websites.length}</span> websites
                      </p>
                    </div>
                    <Button
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {websites.reduce((sum, site) => sum + site.surveyResponses, 0).toLocaleString()}
                          </p>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {(websites.reduce((sum, site) => sum + site.averageRating, 0) / websites.length).toFixed(1)}
                          </p>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {websites.reduce((sum, site) => sum + site.bugReports, 0)}
                          </p>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-gray-900">
                            {websites.reduce((sum, site) => sum + site.featureRequests, 0)}
                          </p>
                        </div>
                ...
                {websites.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-4">Add your first website to start collecting feedback.</p>
                    <Button
                      onClick={() => setCurrentView("create-website")}
                      className="bg-[#F5C842] text-black hover:bg-[#F5C842]/90"
                    >
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <div>
                                    ...
                                    <p className="font-semibold text-gray-900">
                                      {website.totalResponses.toLocaleString()}
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <div>
                                    ...
                                    <p className="font-semibold text-gray-900">{website.feedbackCount}</p>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <div>
                                    ...
                                    <p className="font-semibold text-gray-900">{website.surveyResponses}</p>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <div>
                                    ...
                                    <p className="font-semibold text-gray-900">{website.bugReports}</p>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <div>
                                    ...
                                    <p className="font-semibold text-gray-900">{website.featureRequests}</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="ml-6">
                              <div className="flex items-center space-x-3">
                                <Button
                                  ...
                                  onClick={() => handleViewWebsite(website, "results")}
                                  title="View Details"
                                >
                                ...
                                <Button
                                  ...
                                  onClick={() => handleViewWebsite(website, "build")}
                                  title="Settings"
                                >
