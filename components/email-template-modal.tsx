...
import { Download, Mail, Settings, Eye, Facebook, Twitter, Linkedin, Instagram } from "lucide-react"
...
export function EmailTemplateModal({ open, onClose, surveyInfo }: EmailTemplateModalProps) {
        ...
        <DialogHeader className="px-6 py-4 border-b">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Design and customize your survey invitation email</p>
            </div>
              ...
              <TabsContent value="compose" className="px-6 pb-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label className="text-sm font-medium">
                      Preheader Text{" "}
                      <span className="text-xs text-gray-500">({emailData.preheaderText.length}/140)</span>
                    </Label>
                    <Input
